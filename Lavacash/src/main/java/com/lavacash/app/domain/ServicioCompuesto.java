...
public class ServicioCompuesto extends Servicio  implements ICompuesto{
    ...
    public ServicioCompuesto(int codigo, int tipo, String nombre, String descripcion, double  precio, Time tiempo) {
    ...
    public Time calcularTiempo() {
        Time tiempo = super.getTiempo();
        for (Servicio servicio : servicios) {
            tiempo = new Time( servicio.getTiempo().getTime() + tiempo.getTime() );
        }
        return tiempo;
    }
